...
const MainContainer = (props) => {
  ...
  return (
    <MainCont showNav={showNav} className="w-full font-Regular">
      <TopNav className="w-full flex flex-row  px-9 fixed top-0 z-10 bg-white-main left-0 right-0">
        <div
          className={
            showNav
        ...
        <div className="user-cont">
          ...
          >
            ...
            <div className="absolute bg-secondary-error w-4 h-4 rounded-full ml-10 flex flex-row items-center justify-center animate-bounce">
              <p className="text-xs font-bold text-white-main text-center">
                {pending?.length}
              </p>
            </div>
            ...
            >
              <div className="w-full h-64 relative">
                <div className="w-full h-full px-5 pt-5">
                  ...
                  {name === "Administrator" && pending?.length > 0 && (
                    <div>
                      <p className="text-white-text text-sm font-Bold text-center mt-10">
                        You have {pending?.length} pending withdrawals that
                        needs approval
                      </p>
                      <Link to="/withdraw">
                        {" "}
                        <p className="text-sm mt-6 text-[#166CB4]">View</p>
                      </Link>
                    </div>
                  )}
